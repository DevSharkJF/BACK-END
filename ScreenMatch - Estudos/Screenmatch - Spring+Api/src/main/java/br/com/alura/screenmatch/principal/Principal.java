...
/*              O Optional é uma classe que pode conter um valor ou estar vazia (null), ajudando a evitar NullPointerExceptions
                e a lidar com a ausência de valores de forma mais segura
*/
/*
                filter(e -> e.getTitulo().toUpperCase().contains(trechoTitulo.toUpperCase())): 
                Filtra os elementos com base em uma condição e verifica se o título contém o trecho do título fornecido pelo usuário
                Tanto o título do episódio quando o trecho de título são convertidos para maiúsculas usando toUpperCase()
                findFirst() --> é chamado após o filtro. Ele retorna um Optional que contém o primeiro elemento do fluxo que atende à condição do filtro
*/
...
/*
                        O método collect é utilizado para coletar os elementos do fluxo resultante em uma nova coleção
                        O método groupingBy é um coletor que agrupa os elementos do fluxo, este agrupa os episódios pela temporada
